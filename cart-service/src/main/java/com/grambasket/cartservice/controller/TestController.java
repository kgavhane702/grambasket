package com.grambasket.cartservice.controller; // Change this package for each service
 ...
 */
@RestController
@RequestMapping("/api/cart-service") // A generic path, the service name is handled by the gateway
