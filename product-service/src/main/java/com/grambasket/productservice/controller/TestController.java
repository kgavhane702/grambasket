package com.grambasket.productservice.controller; // Change this package for each service
 ...
 */
@RestController
@RequestMapping("/api/product-service") // A generic path, the service name is handled by the gateway
