package com.grambasket.paymentservice.controller; // Change this package for each service
 ...
 */
@RestController
@RequestMapping("/api/payment-service") // A generic path, the service name is handled by the gateway
