package com.grambasket.deliveryservice.controller; // Change this package for each service
 ...
 */
@RestController
@RequestMapping("/api/delivery-service") // A generic path, the service name is handled by the gateway
