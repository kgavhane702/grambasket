package com.grambasket.inventoryservice.controller; // Change this package for each service
 ...
 */
@RestController
@RequestMapping("/api/inventory-service") // A generic path, the service name is handled by the gateway
