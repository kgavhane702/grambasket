package com.grambasket.notificationservice.controller; // Change this package for each service
 ...
 */
@RestController
@RequestMapping("/api/notification-service") // A generic path, the service name is handled by the gateway
