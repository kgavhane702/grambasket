package com.grambasket.orderservice.controller; // Change this package for each service
 ...
 */
@RestController
@RequestMapping("/api/order-service") // A generic path, the service name is handled by the gateway
