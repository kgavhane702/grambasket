package com.grambasket.reviewratingservice.controller; // Change this package for each service
 ...
 */
@RestController
@RequestMapping("/api/review-rating-service") // A generic path, the service name is handled by the gateway
